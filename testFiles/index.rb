...
def greeting
  ...
  if hasBoth and bothFilled
    tmp="you are the number "+$visits.to_s+" visitor, "+$get[:name]+" "+$get[:surname]+"!"
  elsif $get==Hash.new
    tmp="you are the number "+$visits.to_s+" visitor!"
...
$visits=$client[:index].find(:counter=>"visits").first[:value].to_i
